...
let SchoolService = class SchoolService {
    ...
    deleteCollege(college) {
        ...
        return this.http.get(this.collegeUrl + 'school.ctl?id=' + id, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteCollege')));
    }
